...
const uiValueTranslations: Record<string, { en: string; zh: string }> = {
  ...
  Packed: { en: "Packed", zh: "已打包" },
  Saved: { en: "Saved", zh: "已保存" },
  Printed: { en: "Printed", zh: "已打印" },
  Ready: { en: "Ready", zh: "已准备" },
  Needed: { en: "Needed", zh: "需要" },
  Protected: { en: "Protected", zh: "受保护" },
  Open: { en: "Open", zh: "开放" },
  Completed: { en: "Completed", zh: "已完成" },
  "Not needed": { en: "Not needed", zh: "不需要" },
  "Not needed only": { en: "Not needed only", zh: "仅不需要" },
  "Not packed yet": { en: "Not packed yet", zh: "尚未打包" },
  "Not assigned": { en: "Not assigned", zh: "未分配" },
  "Not protected": { en: "Not protected", zh: "未保护" },
  "Incomplete only": { en: "Incomplete only", zh: "仅未完成" },
  "Completed only": { en: "Completed only", zh: "仅已完成" },
  "Unassigned only": { en: "Unassigned only", zh: "仅未分配" },
  "Protected only": { en: "Protected only", zh: "仅受保护" },
  "Open links only": { en: "Open links only", zh: "仅开放链接" },
  required: { en: "Required", zh: "必需" },
  packed: { en: "Packed", zh: "已打包" },
  saved: { en: "Saved", zh: "已保存" },
  not_needed: { en: "Not needed", zh: "不需要" },
  High: { en: "High", zh: "高" },
  ...
  "Visa / Entry": { en: "Visa / Entry", zh: "签证 / 入境" },
