...
CREATE TABLE IF NOT EXISTS `booking_items` (
  ...
  `currency` enum('EUR', 'SGD', 'MYR', 'USD', 'CNY', 'JPY', 'KRW', 'GBP', 'AUD', 'HKD', 'TWD', 'THB') DEFAULT NULL,
  `notes` text,
...
CREATE TABLE IF NOT EXISTS `itinerary_items` (
  ...
  `currency` enum('EUR', 'SGD', 'MYR', 'USD', 'CNY', 'JPY', 'KRW', 'GBP', 'AUD', 'HKD', 'TWD', 'THB') NOT NULL DEFAULT 'EUR',
  `notes` text,
...
CREATE TABLE IF NOT EXISTS `expenses` (
  ...
  `currency` enum('EUR', 'SGD', 'MYR', 'USD', 'CNY', 'JPY', 'KRW', 'GBP', 'AUD', 'HKD', 'TWD', 'THB') NOT NULL,
